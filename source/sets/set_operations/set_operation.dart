...
abstract class SetOperation<ReturnType> {
  ...
  SetOperation() {
    ...
    _methodTable.addMethod(BuilderSet, IntensionalSetIntersection, operateBuilderSetIntensionalSetIntersection);
    ...
    _methodTable.addMethod(IntensionalSetIntersection, BuilderSet, operateIntensionalSetIntersectionBuilderSet);
    _methodTable.addMethod(IntensionalSetIntersection, IntensionalSetIntersection, operateIntensionalSetIntersectionIntensionalSetIntersection);
    _methodTable.addMethod(IntensionalSetIntersection, Interval, operateIntensionalSetIntersectionInterval);
    _methodTable.addMethod(IntensionalSetIntersection, RosterSet, operateIntensionalSetIntersectionRosterSet);
    _methodTable.addMethod(IntensionalSetIntersection, SetUnion, operateIntensionalSetIntersectionSetUnion);
    _methodTable.addMethod(Interval, BuilderSet, operateIntervalBuilderSet);
    _methodTable.addMethod(Interval, IntensionalSetIntersection, operateIntervalIntensionalSetIntersection);
    ...
    _methodTable.addMethod(RosterSet, IntensionalSetIntersection, operateRosterSetIntensionalSetIntersection);
    ...
    _methodTable.addMethod(SetUnion, IntensionalSetIntersection, operateSetUnionIntensionalSetIntersection);
  ...
  @visibleForOverriding
  ReturnType operateBuilderSetIntensionalSetIntersection(BuilderSet first, IntensionalSetIntersection second);
  ...
  @visibleForOverriding
  ReturnType operateIntensionalSetIntersectionBuilderSet(IntensionalSetIntersection first, BuilderSet second);

  @visibleForOverriding
  ReturnType operateIntensionalSetIntersectionIntensionalSetIntersection(IntensionalSetIntersection first, IntensionalSetIntersection second);

  @visibleForOverriding
  ReturnType operateIntensionalSetIntersectionInterval(IntensionalSetIntersection first, Interval second);

  @visibleForOverriding
  ReturnType operateIntensionalSetIntersectionRosterSet(IntensionalSetIntersection first, RosterSet second);

  @visibleForOverriding
  ReturnType operateIntensionalSetIntersectionSetUnion(IntensionalSetIntersection first, SetUnion second);

  @visibleForOverriding
  ReturnType operateIntervalBuilderSet(Interval first, BuilderSet second);

  @visibleForOverriding
  ReturnType operateIntervalIntensionalSetIntersection(Interval first, IntensionalSetIntersection second);
  ...
  @visibleForOverriding
  ReturnType operateRosterSetIntensionalSetIntersection(RosterSet first, IntensionalSetIntersection second);
  ...
  @visibleForOverriding
  ReturnType operateSetUnionIntensionalSetIntersection(SetUnion first, IntensionalSetIntersection second);
...
abstract class EmptyTreatingSetOperation<ReturnType>
  ...
  EmptyTreatingSetOperation() : super() {
    ...
    _methodTable.addMethod(IntensionalSetIntersection, EmptySet, operateIntensionalSetIntersectionEmptySet);
    _methodTable.addMethod(EmptySet, IntensionalSetIntersection, operateEmptySetIntensionalSetIntersection);
  ...
  @visibleForOverriding
  ReturnType operateIntensionalSetIntersectionEmptySet(IntensionalSetIntersection first, EmptySet second);

  @visibleForOverriding
  ReturnType operateEmptySetIntensionalSetIntersection(EmptySet first, IntensionalSetIntersection  second);
