...
BSFunction abs(BSFunction operand) {
  ...
  if (operand is Negative) operand = operand.operand;
...
class AbsoluteValue extends SingleOperandFunction {
  const AbsoluteValue._(BSFunction operand, [Set<Variable> params = const <Variable>{}])
  ...
  @override
  BSFunction copy([Set<Variable> params = const <Variable>{}]) => AbsoluteValue._(operand, params);
