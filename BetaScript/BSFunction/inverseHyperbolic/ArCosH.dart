...
bscFunction arcosh(bscFunction operand, [bool negative = false]) {
    if (operand is CosH) return operand.operand.invertSign(negative);
    else return ArCosH._(operand, negative);
}
...
class ArCosH extends bscFunction {
  ...
  @override
  String toString([bool handleMinus = true]) => "${minusSign(handleMinus)}arcosh($operand)";
}
